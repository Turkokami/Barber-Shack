...
export const SERVICE_IMAGE: Record<string, { src: string; alt: string }> = {
  ...
  "straight-razor-face-shave": { src: "/images/shave-lather-razor.webp", alt: "A straight razor working through the lather on a client\u2019s jaw at Barber Shack, in black and white." },
  "straight-razor-head-shave": { src: "/images/shave-razor-highkey.webp", alt: "A straight razor taken over the scalp at Barber Shack, in high-key black and white." },
  ...
  "beard-removal": { src: "/images/shave-neck-razor.webp", alt: "A close razor shave down the neckline at Barber Shack, in black and white." },
